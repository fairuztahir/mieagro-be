  ...
  <div class="pa-4">
    ...
    <v-row>
      <v-col class="mx-auto" cols="auto">
        <v-btn color="success" href="https://materialdesignicons.com/" large target="_blank">
          <v-icon left> mdi-material-design </v-icon>
          <span>See all icons</span>
        </v-btn>
        <div class="subtitle-1 font-weight-light text-center">
          mdi cheatsheat
          <a class="white--text" href="https://pictogrammers.github.io/@mdi/font/6.5.95/" target="_blank"> Page </a>
        </div>
      </v-col>
    </v-row>
  </div>
